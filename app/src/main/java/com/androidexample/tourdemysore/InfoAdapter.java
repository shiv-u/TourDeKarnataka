...
//        place.setText(info.getmPlace());
        viewHolder.place = listItemView.findViewById(R.id.textView);
        viewHolder.place.setText(info.getmPlace());


//        ImageView imageView = listItemView.findViewById(R.id.thumbnail);
//        imageView.setImageResource(info.getmImage());
        viewHolder.imageView = listItemView.findViewById(R.id.thumbnail);
        viewHolder.imageView.setImageResource(info.getmImage());
...
//        images.add(listItemView.findViewById(R.id.star5));
       viewHolder.images.add(listItemView.findViewById(R.id.star1));
        viewHolder.images.add(listItemView.findViewById(R.id.star2));
        viewHolder.images.add(listItemView.findViewById(R.id.star3));
        viewHolder.images.add(listItemView.findViewById(R.id.star4));
        viewHolder.images.add(listItemView.findViewById(R.id.star5));

        for (int i = 0; i < stars; i++) {
            viewHolder.images.get(i).setBackgroundResource(R.drawable.favorite);
